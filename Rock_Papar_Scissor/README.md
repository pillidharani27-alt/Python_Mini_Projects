...
This mini project is a simple Rock–Paper–Scissors game built in Python.  
The user plays against the computer, which randomly chooses rock, paper or scissors.
